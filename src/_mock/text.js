...
export const title = [
  'This web app displays data from sensors in realtime',
  'Data from sensors of mobile devices is collected using sensify',
  'Data from sensors of microcontrollers is sent over HTTP',
